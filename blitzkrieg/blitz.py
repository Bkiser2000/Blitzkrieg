...
class Compiler:
    ...
    def compile_node(self, node):
        if isinstance(node, NumberNode):
            ...
            self.compile_node(node.node_to_call)
...
class FastVM:
    ...
    def run_fast_bytecode(self):
        ...
        while ip < len(instructions):
            ...
            if opcode == ByteCode.LOAD_CONST:
                # Use cached Number objects for common values
                value = constants[arg]
                if value in self.number_cache:
